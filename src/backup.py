...
class Backup:
    ...
    def __init__(self):
        ...
        self.sub_2_ = message_filters.Subscriber("/band/ndvi/image_raw", Image)
        ...
        ts = message_filters.ApproximateTimeSynchronizer(
            [self.sub_1_, self.sub_2_, self.sub_3_, self.sub_4_, self.sub_5_], 10, 0.1, allow_headerless=True)
    ...
    def callback(self, in1, in2, in3, in4, in5):
        ...
        if self.OPERATION:
            self.backupImages(img_1, img_2, img_3, img_4,
                              img_5, self.path_stream)

    # Save the backup of the images
    def backupImages(self, img_1, img_2, img_3, img_4, img_5, path):
        ...
        if self.OPERATION:
            ...
            s2 = path + str(self.counter) + "_multispectral_ndvi.png"
            s3 = path + str(self.counter) + "_multispectral_ndvi_colored.png"
            s4 = path + str(self.counter) + "_kinect_hd_rgb.png"
            s5 = path + str(self.counter) + "_kinect_hd_depth.png"
